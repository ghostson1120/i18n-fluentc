export const articles = [
  {
    id: '1',
    title: 'Globalize your applications with multi-language support leveraging AI and CMS',
    body:
      `Problem
  ...
  {
    id: '2',
    title: 'Bad localization can cause confusion among users',
    body:
  ...
  {
    id: '4',
    title: 'Localization and Translation in Healthcare',
    body:
